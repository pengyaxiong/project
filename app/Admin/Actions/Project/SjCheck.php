...
//        }
    ...
    {
        return "/admin/projects/sj/".$this->getKey();
    }
...
//        $this->text('returned_money','回款金额')->default($model->sj_rate*$model->money/100);
//        $this->text('rebate','返渠道费');
//        $this->text('returned_bag','回款账户');
//        $this->text('debtors','未结余额')->default($model->qd_rate*$model->money/100+$model->ys_rate*$model->money/100);
//        $this->textarea('description','开票情况');
//        $this->textarea('remark','项目备注');
//
//
//        $this->confirm('确认设计已完成？','确定？',[]);
//
//        $this->modalLarge();
//    }
